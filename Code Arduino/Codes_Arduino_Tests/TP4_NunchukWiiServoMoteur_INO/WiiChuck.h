...
class WiiChuck
{
  private:
      ...
      byte averageCounterP;
      byte averageCounterR;
      int Pitch[AVERAGE_N];
      int Roll[AVERAGE_N];
      int i;
      int total;
  ...
  public:
    ...
    int readRoll()
    {
      ...
      averageCounterR ++;
      if (averageCounterR >= AVERAGE_N)
      {
        averageCounterR = 0;
      }
      
      Roll[averageCounterR] = (int) (atan2(readAccelX(),readAccelZ())/ M_PI * 180.0);
    ...
    {
      averageCounterP ++;
      if (averageCounterP >= AVERAGE_N)
      {
        averageCounterP = 0;
      }
      
      Pitch[averageCounterP] = (int) (acos(readAccelY()/RADIUS)/ M_PI * 180.0);  // optionally swap 'RADIUS' for 'R()'
